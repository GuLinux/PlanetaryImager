...
public:
  ...
  PlanetaryImagerMainWindow(const Driver::ptr &driver, const SaveImages::ptr &save_images, const Configuration::ptr &configuration, QWidget* parent = 0, Qt::WindowFlags flags = 0);
