...
DPTR_IMPL(ImageFileWriter) {
  ...
  QString filename;
  ImageFileWriter *q;
  function<void(Frame::const_ptr)> writer;
  QString savename(Frame::const_ptr frame, const QString &extension) const;
  QDir savedir;
  void saveFITS(Frame::const_ptr frame) const;
  void saveCV(Frame::const_ptr frame, const QString &extension) const;
};
...
void ImageFileWriter::doHandle(Frame::const_ptr frame)
{
  if(d->writer)
    d->writer(frame);
}
...
QString ImageFileWriter::Private::savename(Frame::const_ptr frame, const QString& extension) const
{
...
END
*/
void ImageFileWriter::Private::saveFITS(Frame::const_ptr frame) const
{
...
void ImageFileWriter::Private::saveCV(Frame::const_ptr frame, const QString& extension) const
{
